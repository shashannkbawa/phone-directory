    ...
    <>
      ...
      <div className="md:hidden">
        <button
          ...
          className="fixed top-5 left-5 z-2000 text-white bg-gray-800 p-3 rounded-md"
        >
      ...
      {/* Sidebar */}
      <div
        className={`fixed z-2000 top-0 left-0 h-full bg-gray-800 text-white transition-transform duration-300 transform ${
      ...
      >
        ...
        >
          ...
          <Link to="/dashboard" onClick={toggleLeftBar}>
            <RowContainer
              className={`w-full h-14 rounded-md justify-center items-center text-white font-bold transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 hover:bg-indigo-500 duration-300 bg-${
